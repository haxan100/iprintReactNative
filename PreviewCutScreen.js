...
const PreviewCutScreen = ({ route, navigation }) => {
  ...
  const Simpan = () => {
    navigation.navigate('PrintCutLanjutan', { image });
  };

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Preview Cut</Text>
...
export default PreviewCutScreen;
